...
public class ClientAuthenticationPacket extends PacketWithHeaderPacket {
    ...
    public byte[] toBytes() throws IOException {
        ...
        // CLIENT_LONG_PASSWORD CLIENT_LONG_FLAG CLIENT_PROTOCOL_41 CLIENT_INTERACTIVE CLIENT_TRANSACTIONS CLIENT_SECURE_CONNECTION
    ...
    public void setServerCapabilities(int serverCapabilities) { this.serverCapabilities = serverCapabilities; }
    public int getServerCapabilities() { return serverCapabilities; }
    public void setScrumbleBuff(byte[] scrumbleBuff) { this.scrumbleBuff = scrumbleBuff; }
    public byte[] getScrumbleBuff() { return scrumbleBuff; }
}
