...
public class OKPacket extends PacketWithHeaderPacket {
    ...
    public void setFieldCount(byte fieldCount) { this.fieldCount = fieldCount; }
    public byte[] getAffectedRows() { return affectedRows; }
    public void setAffectedRows(byte[] affectedRows) { this.affectedRows = affectedRows; }
    public byte[] getInsertId() { return insertId; }
    public void setInsertId(byte[] insertId) { this.insertId = insertId; }
    ...
    public String toString() {
        return "OKPacket [" +
                "affectedRows=" + Arrays.toString(affectedRows) +
                ", fieldCount=" + fieldCount +
                ", insertId=" + Arrays.toString(insertId) +
                ", message=" + message +
