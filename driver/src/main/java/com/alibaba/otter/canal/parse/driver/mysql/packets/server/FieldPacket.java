...
public class FieldPacket extends PacketWithHeaderPacket {
    ...
    private byte   type;
    private int    flags;
    private byte   decimals;    /* TODO */
    private String definition;  /* TODO */
    ...
    public byte getDecimals() { return decimals; }
    public void setDecimals(byte decimals) { this.decimals = decimals; }
    public String getDefinition() { return definition; }
    public void setDefinition(String definition) { this.definition = definition; }
    public String toString() {
        return "FieldPacket [catalog=" + catalog +
                ", character=" + character +
                ", db=" + db +
                ", decimals=" + decimals +
