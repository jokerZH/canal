 ...
 * Bytes        desc
 * -----        ----
 * 4            The ID of the file to load
 * 4            The start position within the statement for filename substitution
 * 4            The end position within the statement for filename substitution.
 * 1            How to handle duplicates: LOAD_DUP_ERROR = 0, LOAD_DUP_IGNORE = 1, LOAD_DUP_REPLACE = 2
 *
 * @author <a href="mailto:changyuan.lh@taobao.com">Changyuan.lh</a>
 * @version 1.0
 */
public final class ExecuteLoadQueryLogEvent extends QueryLogEvent {
    private long            fileId;         /* file_id of temporary file */
    private int             fnPosStart;     /* pointer to the part of the query that should be substituted */
    private int             fnPosEnd;       /* pointer to the end of this part of query */
